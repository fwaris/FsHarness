...
# UI Coding
For UI develop use the Elmish pattern and libraries.
For web ui start with the CoWS framework. See:
- https://github.com/fwaris/CW1
- https://github.com/fwaris/FsOpenAI

For desktop ui use Avalonia + FuncUI
